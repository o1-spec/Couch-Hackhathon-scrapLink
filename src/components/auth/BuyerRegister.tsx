...
export function BuyerRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const success = true // Always succeed for testing - you can change this back to Math.random() > 0.2

      if (success) {
        // Store user type in localStorage for the dashboard to read
        ...
        // Simple redirect to dashboard without query params
        setTimeout(() => {
