...
import { Building2, Mail, ArrowRight, CheckCircle, ArrowLeft } from 'lucide-react'
      ...
      <Card className="w-full max-w-md border-0 shadow-xl">
        <CardContent className="p-8">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2 font-poppins">Reset Business Password</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="businessEmail" className="font-poppins">Business Email Address</Label>
